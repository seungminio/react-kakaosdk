...
var createShareButton = function createShareButton(props) {
  if (props.container) {
    console.warn('container field is Web Only.');
  }
  return function (subProps) {
    return React.createElement(_reactNative.TouchableWithoutFeedback, __assign({
...
var createFollowButton = function createFollowButton(props) {
  console.log(props);
};
var Story = {
